Mac OS X kilocoind build instructions
====================================
...
See `doc/readme-qt.rst` for instructions on building Kilocoin-Qt, the
...
A kilocoind binary is not included in the Kilocoin-Qt.app bundle. You can ignore
this section if you are building `kilocoind` for your own use.
...
on an OS X 10.6 64-bit machine fails. Official release builds of Kilocoin-Qt are
compiled on an OS X 10.6 32-bit machine to workaround that problem.

Once dependencies are compiled, creating `Kilocoin-Qt.app` is easy:
...
It's now available at `./kilocoind`, provided that you are still in the `src`
