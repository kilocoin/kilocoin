...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Kilocoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"kilocoin.com", "dnsseed.kilocoin.com"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"kilocoin.com", "testnet-seed.kilocoin.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Kilocoin is probably already running."), addrBind.ToString().c_str());
        else
